# Chapter 47: Cross-Attention для Multi-Asset Trading

## Описание

Механизм cross-attention для моделирования взаимосвязей между различными активами и рынками.
...
1. **Cross-Asset Attention Network for Portfolio Management**
   - URL: https://arxiv.org/abs/2312.02000
   - Год: 2023
...
## Структура
```
47_cross_attention_multi_asset/
├── README.specify.md
├── README.md
├── docs/
│   └── ru/
